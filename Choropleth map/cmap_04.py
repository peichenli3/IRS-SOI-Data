...
This python script is for creating a choropleth map based on 2004 
"""
...
def cmap_18():
    ...
    plt.savefig(output + '\cmap.pdf', bbox_inches='tight', pad_inches=0.1)
    ...
    print("Note: you need to 'cd' to output folder first")
